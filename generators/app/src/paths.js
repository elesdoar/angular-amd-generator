...
module.exports = function (GulpAngularAMDGenerator) {
   ...
   */
  GulpAngularAMDGenerator.prototype.storePaths = function storePaths() {
   ...
   */
  GulpAngularAMDGenerator.prototype.computePaths = function computePaths() {
    this.computedPaths = {
