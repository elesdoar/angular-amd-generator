...
var rejectWithRegexp = function(regexp) {
...
module.exports = function (GulpAngularAMDGenerator) {
   ...
   */
  GulpAngularAMDGenerator.prototype.computeProcessedFileExtension = function computeProcessedFileExtension() {
   ...
   */
  GulpAngularAMDGenerator.prototype.computeWatchTaskDeps = function computeInjectTaskDeps() {
    this.watchTaskDeps = [];
   ...
   */
  GulpAngularAMDGenerator.prototype.rejectFiles = function rejectFiles() {
   ...
   */
  GulpAngularAMDGenerator.prototype.lintCopies = function lintCopies() {
   ...
   */
  GulpAngularAMDGenerator.prototype.travisCopies = function travisCopies() {
