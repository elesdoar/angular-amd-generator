...
var logChoice = function(prompt, prop) {
...
module.exports = function (GulpAngularAMDGenerator) {
   ...
   */
  GulpAngularAMDGenerator.prototype.defaultOption = function defaultOption() {
   ...
   */
  GulpAngularAMDGenerator.prototype.checkYoRc = function checkYoRc() {
    var done = this.async();
   ...
   */
  GulpAngularAMDGenerator.prototype.askQuestions = function askQuestions() {
