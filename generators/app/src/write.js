...
module.exports = function(GulpAngularAMDGenerator) {
   ...
   */
  GulpAngularAMDGenerator.prototype.writeYoRc = function writeYoRc() {
   ...
   */
  GulpAngularAMDGenerator.prototype.writeFiles = function writeFiles() {
   ...
   */
  GulpAngularAMDGenerator.prototype.install = function install() {
   ...
   * End message
   */
  GulpAngularAMDGenerator.prototype.end = function end() {
    ...
    this.log('https://github.com/elesdoar/angular-amd-generator/tree/master/docs');
  };
};
